<section>
    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6">
        ...
        <div>
            ...
            <x-text-input id="joined_on" name="joined_on" type="date" class="mt-1 block w-full" :value="old('joined_on', $user->joined_on)" autofocus autocomplete="joined_on" />
            <x-input-error class="mt-2" :messages="$errors->get('joined_on')" />
        </div>
